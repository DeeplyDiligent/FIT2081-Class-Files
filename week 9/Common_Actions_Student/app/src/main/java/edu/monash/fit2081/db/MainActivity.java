...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_shape) {
            ...
            myMenu.getItem(2).setIcon(getResources().getDrawable(R.drawable.line, null));
            myMenu.getItem(3).setIcon(getResources().getDrawable(R.drawable.oval, null));
            ...
            selectedShapeDrawing = "SLine";
            myMenu.getItem(0).setIcon(getResources().getDrawable(R.drawable.ic_circle_black, null));
            myMenu.getItem(1).setIcon(getResources().getDrawable(R.drawable.ic_square_black, null));
            myMenu.getItem(2).setIcon(getResources().getDrawable(R.drawable.line_white, null));
            myMenu.getItem(3).setIcon(getResources().getDrawable(R.drawable.oval, null));
            ...
            myMenu.getItem(1).setIcon(getResources().getDrawable(R.drawable.ic_square_black, null));
            myMenu.getItem(2).setIcon(getResources().getDrawable(R.drawable.line, null));
            myMenu.getItem(3).setIcon(getResources().getDrawable(R.drawable.oval_white, null));
