...
public class Lifecycles extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewDataEditText.setText(preferences.getString("viewDataText",""));
        nonViewDataEditText = (EditText) findViewById(R.id.nonViewDataEditText);
        nonViewDataEditText.setShowSoftInputOnFocus(false);
        nonViewDataEditText.setText(preferences.getString("nonViewDataText",""));
        ...
        persistentDataEditText.setText(preferences.getString("persistentDataText",""));
    }
    ...
    protected void onPause() {
        ...
        SharedPreferences.Editor preferenceEditor = getSharedPreferences(SP_FILE_NAME,0).edit();
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString("NONVIEW STATE", nonViewState);
    ...
    protected void onRestoreInstanceState(Bundle inState) {
        ...
        nonViewState = inState.getString("NONVIEW STATE");
    ...
    private void saveSharedPreferences(){
        SharedPreferences.Editor preferenceEditor = getSharedPreferences(SP_FILE_NAME,0).edit();
        preferenceEditor.putString("PERSISTENT",persistentState);
        preferenceEditor.commit();
    }

    private void restoreSharedPreferences(){
        SharedPreferences preferenceEditor = getSharedPreferences(SP_FILE_NAME,0);
        persistentState = preferenceEditor.getString("PERSISTENT","0");
    }
