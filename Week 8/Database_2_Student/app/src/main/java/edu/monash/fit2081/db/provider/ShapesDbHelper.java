...
//
//
//        //can't delete what you can't find
//        String query = "SELECT * FROM " + SchemeShapes.Shape.TABLE_NAME +
//                " WHERE " + SchemeShapes.Shape.ID + "=\"" + shapeID + "\"";
//
//        SQLiteDatabase db = this.getWritableDatabase();
//        Cursor cursor = db.rawQuery(query, null);
//
//        //delete if record found
//        if (cursor.moveToFirst()) { //if true a record with the id to delete was found
//            //ShapeValues shape = new ShapeValues();
//
//            //shape.setId(Integer.parseInt(cursor.getString(0)));
//            result = db.delete(SchemeShapes.Shape.TABLE_NAME, SchemeShapes.Shape.ID + " = ?",
//                    new String[]{String.valueOf(shapeID)}) == 0;
//
//            cursor.close();
//            //result = true;
//        }
...
//
//        ContentValues contentValues = new ContentValues(); //update method
//
//        contentValues.put(SchemeShapes.Shape.SHAPE_TYPE, shape.getShapeType());
//        contentValues.put(SchemeShapes.Shape.SHAPE_X, shape.getX());
//        contentValues.put(SchemeShapes.Shape.SHAPE_Y, shape.getY());
...
//        SQLiteDatabase db = this.getWritableDatabase();
//
//        result = db.update(SchemeShapes.Shape.TABLE_NAME, contentValues,
//                SchemeShapes.Shape.ID + " = " + shape.getId(), null) == 0;
//
//        db.close();
//
//        return result;
